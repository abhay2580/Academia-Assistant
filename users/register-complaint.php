...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,course,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$course','$noc','$complaintdetials','$compfile')");
...
<html lang="en">
  <head>
    ...
    <title>Academia Assistant | User Register Complaint</title>
...
<?php $sql=mysqli_query($con,"select courseName from course ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
